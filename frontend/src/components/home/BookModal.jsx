    ...
    >
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <p className="mt-8">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae, nam facere odio nostrum dolores laborum consequuntur, perspiciatis ullam assumenda repellat, deleniti facilis iure nisi. Repudiandae id ea quibusdam odit cum!
          </p>
        </div>
      </div>
    </div>
